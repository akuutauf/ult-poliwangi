                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="card-body">
                            <div>
                                <div class="card-body d-flex">
                                    <img src="{{ asset('images/pemohon-umum.png') }}" class="img-fluid mx-auto" alt="">
                                </div>
                            </div>
                            <div class="row">
                                <center>
    ...
    <div class="container py-5">
        <div class="row py-5 d-flex justify-content-around">
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 mb-5 d-flex">
                <img src="{{ asset('images/logo-title-poliwangi.png') }}" class="img-fluid mx-auto my-auto" width="300"
                    alt="">
            </div>
