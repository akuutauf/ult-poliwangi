                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="nim_mahasiswa" name="nim_mahasiswa"
                            ...
                            <div class="col-md-6 mb-1">
                                <label class="form-label" for="semester_mahasiswa">Semester</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text"><i class="fa-solid fa-book-bookmark"></i></span>
                                    <select class="form-control" id="semester_mahasiswa" name="semester_mahasiswa">
