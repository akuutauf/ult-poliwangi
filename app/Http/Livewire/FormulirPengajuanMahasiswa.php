...
class FormulirPengajuanMahasiswa extends Component
{
     public $byLayanans;
    ...
    public function render()
    {
        ...
        return view('livewire.formulir-pengajuan-mahasiswa', compact('persyaratan_berkas', 'prodis', 'berkas_layanans', 'layanans'));
    }
