...
class FormulirPengajuanDosen extends Component
{
    public $byLayanans;
    ...
    public function render()
    {
        ...
        return view('livewire.formulir-pengajuan-dosen', compact('persyaratan_berkas', 'prodis', 'berkas_layanans', 'layanans'));
    }
